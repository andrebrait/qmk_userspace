...
// A debounce of 5 represents a minimum key press time of just under 1 refresh at 200Hz.
// Still possible to press and release a key within a single frame at up to 100Hz using asym_eager_defer_pk
#ifdef DEBOUNCE
#    undef DEBOUNCE
#endif
#define DEBOUNCE 5
